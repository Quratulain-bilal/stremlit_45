...
# name of the pizza. For each pizza you should have

# one line of output containing a simple
...
pizza=['cheezy','bbq pizza','vegitable pizza']

for i in pizza:
     print(f"I like {i} pizza.")
     
# Step 3: Final statement outside the loop
print("\nI really love pizza!")
